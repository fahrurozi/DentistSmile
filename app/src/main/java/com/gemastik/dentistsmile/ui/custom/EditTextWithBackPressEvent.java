package com.gemastik.dentistsmile.ui.custom;
...
public class EditTextWithBackPressEvent extends androidx.appcompat.widget.AppCompatEditText {

    private MyEditTextListener onBackPressListener;

    public EditTextWithBackPressEvent(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
