...
class ImageSegmentationHelper(
    ...
    private fun setupImageSegmenter() {
        ...
        try {
            ...
            Log.e("TFLiteError", "TFLite failed to load model with error: " + e.message)
        }
    }
    ...
    companion object {
        ...
        const val MODEL_DEEPLABV3 = "dentistsmile_segmentation_litemodel_with_md640.tflite"
